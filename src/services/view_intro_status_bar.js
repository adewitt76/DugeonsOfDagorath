...
export class IntroStatusBar {

  /** @private @type { IntroStatusBar } */
  static _instance;
   ...
   * @return { IntroStatusBar } 
   */
  static get instance() {
    if (this._instance) return this._instance;
    this._instance = new IntroStatusBar();
  ...
  paint() {
    ...
    this.print_left_text('copyright  dyna micro');
    this.print_right_text('mcmlxxxii');
  }
